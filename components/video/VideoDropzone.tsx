  ...
  return (
    ...
    >
      <rect
        ...
        ry="12"
        fill="none"
        stroke={active ? '#7C5CFF' : 'rgba(255,255,255,0.12)'}
        strokeWidth="1.5"
        strokeDasharray="8 4"
        style={{
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          'focus-visible:ring-2 focus-visible:ring-[#7C5CFF]/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#08060F]',
          className
        )}
        style={{
          height,
        ...
        {fileCount > 0 ? (
          ...
          <div className="flex flex-col items-center gap-2.5 px-4 text-center">
            <div
              className="flex items-center justify-center w-9 h-9 rounded-full"
              style={{
                background: isDragOver ? 'rgba(124, 92, 255,0.15)' : 'rgba(255,255,255,0.06)',
                color: isDragOver ? '#7C5CFF' : '#71717A',
            ...
            <div>
              <p
                ...
                style={{
                  color: isDragOver ? '#7C5CFF' : '#A1A1AA',
