...
const PLANS = [
  {
    name: 'Free', price: '$0', period: 'forever', desc: 'Perfect to start. No credit card.',
    features: ['1 store', 'Up to 10 products', 'yourstore.brandlift.app subdomain', 'AI store builder', 'Built-in checkout', 'Basic analytics', 'BrandLift branding'],
    cta: 'Start for free', href: '/sign-up', highlight: false,
  },
  {
    name: 'Pro', price: '$19', period: 'per month', desc: 'For serious sellers.',
    features: ['Unlimited stores', 'Unlimited products', 'Custom domain', 'Remove BrandLift branding', 'Advanced analytics', 'Priority AI generation', 'Email support'],
    ...
    <section id="pricing" className="py-24" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-[40px] font-extrabold text-[#FAFAFA] mb-4" style={{ letterSpacing: '-0.04em' }}>Free to start. Upgrade when you grow.</h2>
          <p className="text-[16px] text-[#71717A] max-w-lg mx-auto">Start completely free — no credit card, no time limit. Upgrade for custom domains and more.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {PLANS.map((plan, i) => (
            ...
            >
              {plan.highlight && (
                <div className="self-start px-2.5 py-1 rounded-full text-[11px] font-semibold" style={{ background: 'rgba(124,92,255,0.2)', color: '#B9A5FF' }}>
                  Coming soon
                </div>
              )}
              <div>
              ...
              <ul className="flex flex-col gap-2.5">
                {plan.features.map((f) => (
                  <li key={f} className="flex items-center gap-2.5">
                    <div className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(124,92,255,0.15)', border: '1px solid rgba(124,92,255,0.3)' }}>
