...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  trending: [
    'bg-gradient-to-r from-[rgba(124, 92, 255,0.15)] to-[rgba(139,92,246,0.15)]',
    'text-brand-primary',
    'border border-[rgba(124, 92, 255,0.25)]',
  ].join(' '),
...
const platformStyles: Record<PlatformType, string> = {
  ...
  website: 'bg-brand-surface-elevated text-brand-primary border border-[rgba(124, 92, 255,0.3)]',
