...
export async function GET(req: NextRequest) {
  ...
  return new NextResponse(
    ...
    <body style="margin:0;padding:60px 20px;background:#08060F;font-family:-apple-system,sans-serif;text-align:center;">
      <div style="max-width:420px;margin:0 auto;">
        <div style="font-size:20px;font-weight:800;color:#7C5CFF;margin-bottom:24px;">BrandLift</div>
