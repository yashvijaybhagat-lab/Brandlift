  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'rgba(124, 92, 255,0.12)', border: '0.5px solid rgba(124, 92, 255,0.2)' }}
      >
        <Icon className="w-4 h-4" style={{ color: '#B9A5FF' }} />
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 70% 60% at 40% 50%, rgba(124, 92, 255,0.1) 0%, transparent 70%)',
        }}
      />
      ...
      >
        <div
          ...
          style={{
            background: '#7C5CFF',
            boxShadow: '0 0 0 1px rgba(124, 92, 255,0.3), 0 0 60px rgba(124, 92, 255,0.35), 0 20px 40px rgba(0,0,0,0.5)',
          }}
        >
          ...
          {[
            ...
            <div key={f} className="flex items-center gap-2.5">
              <div className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(124, 92, 255,0.15)', border: '0.5px solid rgba(124, 92, 255,0.3)' }}>
                <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><path d="M1.5 4L3 5.5L6.5 2.5" stroke="#B9A5FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </div>
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        style={{
          background: focused ? 'rgba(124, 92, 255,0.06)' : 'rgba(255,255,255,0.04)',
          border: `1px solid ${focused ? 'rgba(124, 92, 255,0.45)' : 'rgba(255,255,255,0.08)'}`,
    ...
    <div className="flex h-[100dvh] w-full overflow-hidden" style={{ background: '#080809' }}>
      ...
      <div className="relative flex w-full lg:w-1/2 h-full flex-col items-center justify-center px-8 lg:px-16">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse 50% 40% at 70% 50%, rgba(124, 92, 255,0.06) 0%, transparent 70%)' }}
        />
        ...
        <div className="relative z-10 w-full max-w-[380px]">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  style={{ color: '#52525B' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#B9A5FF')}
          ...
          >
            ...
            <Link
              ...
              onMouseLeave={(e) => (e.currentTarget.style.color = '#B9A5FF')}
            >
              Sign up free →
            </Link>
          </motion.p>
