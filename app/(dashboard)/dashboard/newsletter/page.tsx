...
export default function NewsletterPage() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error ?? 'Send failed'); setSendState('error'); return }
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-2xl mx-auto px-6 py-8 flex flex-col gap-8">
          ...
          {/* Templates */}
          <div>
            <p className="text-[12px] font-semibold text-[#52525B] uppercase tracking-wider mb-3">Quick templates</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[13px] font-medium text-[#A1A1AA]">
                Body
                <span className="ml-2 text-[11px] text-[#52525B] font-normal">HTML supported — use &lt;p&gt;, &lt;strong&gt;, &lt;ul&gt;, &lt;li&gt;</span>
              </label>
