...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ background: '#08060F', margin: 0, fontFamily: 'Inter, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, textAlign: 'center', maxWidth: 400, padding: '0 24px' }}>
          ...
          <button
            onClick={reset}
            style={{ padding: '10px 20px', borderRadius: 12, background: '#7C5CFF', color: 'white', border: 'none', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}
          >
            Try again
          </button>
        </div>
